...
from api.shared.graph_mail_base import list_recent_messages, list_attachments
...
def find_latest_sell_through_email(token: str) -> Dict[str, Any]:
    mailbox = os.environ["MAILBOX_USER"]
    subject_contains = _norm(os.environ.get("SELL_THROUGH_MAIL_SUBJECT_3E"))
    from_filter = _norm(os.environ.get("SELL_THROUGH_MAIL_FROM_3E"))
    att_name_contains = _norm(os.environ.get("SELL_THROUGH_ATTACHMENT_NAME_CONTAINS", ".csv"))
    top = int(os.environ.get("SELL_THROUGH_MAX_MESSAGES", "100"))
